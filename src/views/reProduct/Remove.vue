<template>
    <div class="remove-pro-container flex-row">
        <div class="inner-remove-container flex-column">
          <div class="back-home-div flex-row" @click="this.goBack">
            <i class="bi bi-chevron-left goleft-icon flex-row"></i>
          </div>
        <form class="sedig-form flex-column" @submit.prevent="this.popProduct">
        <div class="sku-input-remove-search flex-row">
